...
class MLmodel:    
    ...
    def __init__(self):
        ...
        MODEL_DIR = os.path.join(ROOT_DIR, "fastbert/Mask_RCNN-master/logs/")

        # Local path to trained weights file
        COCO_MODEL_PATH = os.path.join(ROOT_DIR, "fastbert/Mask_RCNN-master/logs/mask_rcnn_blood and nonviolence_0010.h5")#change
